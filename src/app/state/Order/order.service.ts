...
export class OrderService {
  ...
  getAllOrders() {
    return this.http
      .get(`${this.API_BASE_URL}/admin/orders/`, { headers: this.headers })
      .pipe(
        map((data) => {
  ...
  confirmedOrder(orderId: Number) {
    return this.http
      .put(`${this.API_BASE_URL}/admin/orders/${orderId}/confirmed`,{}, {
  ...
  shipOrder(orderId: Number) {
    return this.http
      .put(`${BASE_API_URL}/admin/orders/${orderId}/ship`,{}, {
        headers: this.headers,
      })
      .pipe(
        map((data) => {
  ...
  deliverOrder(orderId: Number) {
    return this.http
      .put(`${this.API_BASE_URL}/admin/orders/${orderId}/deliver`,{}, {
        headers: this.headers,
      })
      .pipe(
        map((data) => {
  ...
  deleteOrder(orderId: Number) {
    return this.http
      .put(`${this.API_BASE_URL}/admin/orders/${orderId}/delete`,{}, { headers: this.headers })
      .pipe(
        map((data) => {
          console.log(' get all orders ', data);
