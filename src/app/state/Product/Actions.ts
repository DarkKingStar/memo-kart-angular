...
export const getSearchedProductsRequest = createAction(
  '[Product] Get Searched Products Request',
  props<{ reqData: any }>()
)
export const getSearchedProductsSuccess = createAction(
  '[Product] Get Searched Products Success',
  props<{ payload: any }>()
)
export const getSearchedProductsFailure = createAction(
  '[Product] Get Searched Products Failure',
  props<{ error: any }>()
)
