...
import {
  ...
  getSearchedProductsFailure,
  getSearchedProductsSuccess,
...
import { ProductRequest, ProductSearch } from '../../Models/Product';
@Injectable({
  providedIn: 'root',
})
export class ProductService {
  ...
  findProductsByCategory(reqData: ProductRequest) {
    ...
    return this.http
      .get(`${this.API_BASE_URL}/all/products`, { params })
      .pipe(
  ...
  findProductById(productId: any) {
    const headers = this.getHeaders();
    return this.http
      .get(`${this.API_BASE_URL}/all/products/id/${productId}`, {  })
      .pipe(
  ...
  createProduct(product: any) {
    const headers = this.getHeaders();
    return this.http
      .post(`${this.API_BASE_URL}/prod/admin/products/`, product, {
        headers,
      })
      .pipe(
        map((data: any) => {
  ...
  deleteProduct(productId: any) {
    const headers = this.getHeaders();
    return this.http
      .delete(`${this.API_BASE_URL}/prod/admin/products/${productId}/delete`, {
        headers,
      })
      .pipe(
        map((data: any) => {
  ...
  findRecentllyAddedProduct() {
    const headers = this.getHeaders();
    return this.http
      .get(`${this.API_BASE_URL}/prod/admin/products/recent`, { headers })
      .pipe(
        map((data: any) => {
  ...
  getSearchedProducts(reqData: ProductSearch){
    const {
      query
    } = reqData;
    ...
    return this.http
    .get(`${this.API_BASE_URL}/all/products/search`, { params })
    .pipe(
      map((data: any) => getSearchedProductsSuccess({ payload: data })),
      catchError((error: any) => {
        return of(
          getSearchedProductsFailure(
            error.response && error.response.data.message
